...
const Main = () => {
  ...
  return (
    <div id="Main" className="bg-[#0F1419] text-white relative left-[22vw]">
      <div id="back-box-icon" className="bg-[#0F1419] text-white">
        <div id="box-user-name-back">
          <BiArrowBack id="back" size={29}/>
      ...
      <div id="user-box">
        ...
        <p id="user-name-e" className="text-[#8899A6]">@matinturkaman</p>
        <p>👨‍💻 frontend</p>
        <div id="dateBox">
          <CgCalendarDates />
          <p id="date" className="text-[#8899A6]">Joined May 2021</p>
        </div>
        <div id="following-followers">
          <span id="bold">35</span>
          <p id="following" className="text-[#8899A6]">Following</p>
          <span id="bold">{follow === false ? 6 : 5}</span>
          <p id="followers" className="text-[#8899A6]">Followers</p>
        </div>
      </div>
